...
public class TweetViewHolder extends ViewHolder {
    ...
    public TweetViewHolder(ItemTweetBinding binding) {
    ...
    public void bind(Tweet tweet, Context context) {
        ...
        bindPhoto(tweet.getPhotoUrl(), binding.ivImage, context);
    ...
    private void bindPhoto(String path, ImageView view, Context context) {
        Glide.with(context)
                .load(path)
                .placeholder(R.drawable.progress_animation)
                .into(view);
